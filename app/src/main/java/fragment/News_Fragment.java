...
public class News_Fragment extends Fragment{
    ...
    public class MyAdapterNews extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.user_head_imageview.setOnClickListener(new OnClickListener() {
            ...
            holder.guanzhu_imageview.setOnClickListener(new OnClickListener() {
            ...
            holder.like_imageview.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            holder.news_imageview.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
            ...
            holder.news_detail_textview.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
